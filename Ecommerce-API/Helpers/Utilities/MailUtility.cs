...
namespace Ecommerce_API.Helpers.Utilities
{
    public interface IMailUtility
    {
        ...
        Task SendListMailAsync(List<string> toMail, List<string> ccMail, string subject, string content, string filePath = "");
    }
    public class MailUtility : IMailUtility
    {
        ...
        public async Task SendListMailAsync(List<string> toMail, List<string> ccMail, string subject, string content, string filePath = "")
        {
            MailMessage mail = new MailMessage();
            var test = _configuration.GetSection("MailSettingServer:Server").Value;
            SmtpClient smtpServer = new SmtpClient(_configuration.GetSection("MailSettingServer:Server").Value);
